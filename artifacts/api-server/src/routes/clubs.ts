  ...
  async (req: Request, res: Response) => {
    ...
    res.status(201).json(
      serializeJoinRequest({
        ...
        batch: null,
        message: (created as any).message ?? null,
        status: "pending",
  ...
  async (req: Request, res: Response) => {
    ...
    res.status(201).json(
      serializeEvent({
        ...
        startsAt: (created as any).startsAt,
        endsAt: (created as any).endsAt ?? null,
        venue: (created as any).venue,
        capacity: (created as any).capacity ?? null,
        coverUrl: (created as any).coverUrl ?? null,
  ...
  async (req: Request, res: Response) => {
    ...
    res.status(201).json(
      serializeMedia({
        ...
        caption: ((created as any).caption as string | null) ?? null,
